<?php
/**
 * Entities MultiMailer Base Class
 *
 ...
 */
class EntitiesMultiMailer extends PHPMailer
{
    /**
     * 'from' address
     *
     ...
     * @access private
     */
    var $FromName = 'Chronolabs Entities Repository';
     ...
     * @return void
     */
    function EntitiesMultiMailer($from, $fromName, $method = 'mail')
    {
        $this->From = $from;
