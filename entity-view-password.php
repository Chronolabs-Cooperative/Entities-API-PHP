...
<head>
	...
	<title><?php echo $servicename; ?> (<?php echo $servicecode; ?>) Entity Viewer Password Required || Chronolabs Cooperative</title>
	<meta property="og:title" content="<?php echo $servicecode; ?> API"/>
	<meta property="og:type" content="<?php echo strtolower($servicecode); ?>-api"/>
</head>
<body>
<form id="password-view" name="password-view" action="<?php echo API_URL . $_SERVER["REQUEST_URI"]; ?>" method='post' enctype='multipart/form-data' >
<div class="main">
    <h1><?php echo $servicename; ?> (<?php echo $servicecode; ?>) Entity Viewer Password Required || Chronolabs Cooperative</h1>
