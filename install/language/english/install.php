...
define('API_URL_SHORT_LABEL', 'Shortened URL (Must contain [ %s ] for subdomain specification!)');
define('API_URL_SHORT_HELP', 'Shortened URL Domains\'');
define('API_URL_PLACES_LABEL', 'Geospatial Places REST API (<a href="https://github.com/Chronolabs-Cooperative/Places-API-PHP" target="_blank">Download + Install</a>)');
define('API_URL_PLACES_HELP', 'Geospatial Places REST API Must be installed at this path');
define('API_URL_LOOKUPS_LABEL', 'IP Locational Lookups REST API (<a href="https://github.com/Chronolabs-Cooperative/Lookups-API-PHP" target="_blank">Download + Install</a>)');
define('API_URL_LOOKUPS_HELP', 'IPv4, IPv6, TLD, gTLD locational lookups REST API must be installed at this path');
define('API_URL_WHOIS_LABEL', 'IP + Domain WhoIS REST API (<a href="https://github.com/Chronolabs-Cooperative/WhoIS-API-PHP" target="_blank">Download + Install</a>)');
define('API_URL_WHOIS_HELP', 'IP + Domain WhoIS REST API must be installed at this path!');
define('API_URL_STRATA_LABEL', 'Internet Strata REST API (<a href="https://github.com/Chronolabs-Cooperative/Strata-API-PHP" target="_blank">Download + Install</a>)');
define('API_URL_STRATA_HELP', 'Internet Realm/Domain REST API must be installed at this path!');
define('PATHS_EXTRA', "More Settings/Config's");