...
?>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="xolabel" for="short_url"><?php echo API_URL_SHORT_LABEL; ?></label>
                <div class="xoform-help alert alert-info"><?php echo API_URL_SHORT_HELP; ?></div>
                <input type="text" class="form-control" name="SHORT_URL" id="short_url" value="<?php echo $ctrl->apiShortUrl; ?>" onchange="removeTrailing('short_url', this.value)"/>
            </div>

            <div class="form-group">
                <label class="xolabel" for="places_url"><?php echo API_URL_PLACES_LABEL; ?></label>
                <div class="xoform-help alert alert-info"><?php echo API_URL_PLACES_HELP; ?></div>
                <input type="text" class="form-control" name="PLACES_URL" id="places_url" value="<?php echo $ctrl->apiPlacesUrl; ?>" onchange="removeTrailing('short_url', this.value)"/>
            </div>

            <div class="form-group">
                <label class="xolabel" for="lookups_url"><?php echo API_URL_LOOKUPS_LABEL; ?></label>
                <div class="xoform-help alert alert-info"><?php echo API_URL_LOOKUPS_HELP; ?></div>
                <input type="text" class="form-control" name="LOOKUPS_URL" id="lookups_url" value="<?php echo $ctrl->apiLookupsUrl; ?>" onchange="removeTrailing('short_url', this.value)"/>
            </div>

            <div class="form-group">
                <label class="xolabel" for="whois_url"><?php echo API_URL_WHOIS_LABEL; ?></label>
                <div class="xoform-help alert alert-info"><?php echo API_URL_WHOIS_HELP; ?></div>
                <input type="text" class="form-control" name="WHOIS_URL" id="whois_url" value="<?php echo $ctrl->apiWhoisUrl; ?>" onchange="removeTrailing('short_url', this.value)"/>
            </div>

            <div class="form-group">
                <label class="xolabel" for="strata_url"><?php echo API_URL_STRATA_LABEL; ?></label>
                <div class="xoform-help alert alert-info"><?php echo API_URL_STRATA_HELP; ?></div>
                <input type="text" class="form-control" name="STRATA_URL" id="strata_url" value="<?php echo $ctrl->apiStrataUrl; ?>" onchange="removeTrailing('short_url', this.value)"/>
            </div>
